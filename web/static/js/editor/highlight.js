...
highlightHandler.prototype = import$(Object.create(Object.prototype), {
  ...
  toggle: function(v, e){
    ...
    this.toggled = v = v != null
      ...
      : !this.isToggled();
    if (!v) {
      return ref$ = this.root.style, ref$.opacity = 0, ref$.pointerEvents = 'none', ref$;
    }
    box = this.root.getBoundingClientRect();
    return ref$ = this.root.style, ref$.opacity = 1, ref$.pointerEvents = 'auto', ref$.left = ((ref1$ = (ref3$ = e.clientX - box.width / 2) > 0 ? ref3$ : 0) < (ref2$ = window.innerWidth - box.width) ? ref1$ : ref2$) + "px", ref$.top = ((ref1$ = (ref3$ = e.clientY - box.height / 2) > 0 ? ref3$ : 0) < (ref2$ = window.innerHeight - box.height) ? ref1$ : ref2$) + "px", ref$;
  },
  poll: function(){
    var this$ = this;
  ...
  init: function(){
    ...
    this.root = ld$.find('[ld-scope=highlight]', 0);
