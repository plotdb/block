...
(function(){
  ...
  csscope.prototype = import$(Object.create(Object.prototype), {
    convert: function(arg$){
      var css, scope, ret, i$, ref$, len$, rule, sel;
      css = arg$.css, scope = arg$.scope;
  ...
  csscope.convert = function(opt){
    opt == null && (opt = {});
    if (!csscope['default']) {
      csscope['default'] = new csscope();
    }
    return csscope['default'].convert(opt);
  };
